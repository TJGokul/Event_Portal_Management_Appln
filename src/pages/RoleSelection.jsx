    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-950 text-white p-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Student Card */}
          <div className="bg-slate-850 border border-slate-800/80 rounded-2xl p-5 flex flex-col justify-between hover:border-indigo-500/50 transition-all duration-300">
            <div>
              ...
              <h2 className="text-lg font-bold text-slate-100">Student Voter</h2>
          ...
          {/* Manager Card */}
          <div className="bg-slate-850 border border-slate-800/80 rounded-2xl p-5 flex flex-col justify-between hover:border-violet-500/50 transition-all duration-300">
            <div>
              ...
              <h2 className="text-lg font-bold text-slate-100">Election Manager</h2>
